...
import { Value, ValueType, numberValue, hexValue, bigIntValue, stringValue, uomValue, vectorValue } from "@solve-js/vm/Value";
...
describe("FormatEngine Fuzz", () => {
  const valueTypes: Array<{ name: string; value: Value }> = [
    ...
    { name: "vector_empty", value: vectorValue([]) },
    { name: "vector_large", value: vectorValue([1e10, 2e10, 3e10]) },
