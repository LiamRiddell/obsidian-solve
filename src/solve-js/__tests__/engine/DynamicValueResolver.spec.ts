/**
 * DynamicValueResolver — Unit Tests
 *
 * Tests the dynamic data source polling system:
 * - Batch merging (enqueueUpdate + flushBatch)
 * - Pause/resume and timer lifecycle
 * - Clear/cleanup of sources and pending updates
 */
