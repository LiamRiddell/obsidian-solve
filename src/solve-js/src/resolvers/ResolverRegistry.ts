 ...
 *
 * @deprecated The throw-AsyncSuspenseError fallback path is deprecated
 * in favor of the VM returning { type: 'pending' } directly.
 * preflight() should always be implemented going forward.
 */
