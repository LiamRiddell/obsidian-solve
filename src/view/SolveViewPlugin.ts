...
import { ViewUpdate, PluginValue, EditorView, ViewPlugin, PluginSpec, Decoration, DecorationSet } from "@codemirror/view";
...
export const solveViewPlugin = ViewPlugin.fromClass(SolveViewPlugin, pluginSpec);