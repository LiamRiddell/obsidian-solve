// AUTOGENERATED FILE
// This file was generated from Vector4Arithmetic.ohm by `ohm generateBundles`.
...
export interface Vector4ArithmeticActionDict<T> extends BasicArithmeticActionDict<T> {
  Expression?: (this: NonterminalNode, arg0: NonterminalNode) => T;
  P_parenthesis?: (this: NonterminalNode, arg0: TerminalNode, arg1: NonterminalNode, arg2: TerminalNode) => T;
  P?: (this: NonterminalNode, arg0: NonterminalNode) => T;
  MD_multiplication?: (this: NonterminalNode, arg0: NonterminalNode, arg1: NonterminalNode, arg2: NonterminalNode) => T;
  MD_division?: (this: NonterminalNode, arg0: NonterminalNode, arg1: NonterminalNode, arg2: NonterminalNode) => T;
  MD?: (this: NonterminalNode, arg0: NonterminalNode) => T;
  Vector4_parse?: (this: NonterminalNode, arg0: IterationNode, arg1: TerminalNode, arg2: NonterminalNode, arg3: TerminalNode, arg4: NonterminalNode, arg5: TerminalNode, arg6: NonterminalNode, arg7: TerminalNode, arg8: NonterminalNode, arg9: TerminalNode) => T;
  Vector4?: (this: NonterminalNode, arg0: NonterminalNode) => T;
...
export interface Vector4ArithmeticSemantics extends Semantics {
  addOperation<T>(name: string, actionDict: Vector4ArithmeticActionDict<T>): this;
  extendOperation<T>(name: string, actionDict: Vector4ArithmeticActionDict<T>): this;
  addAttribute<T>(name: string, actionDict: Vector4ArithmeticActionDict<T>): this;
  extendAttribute<T>(name: string, actionDict: Vector4ArithmeticActionDict<T>): this;
}

export interface Vector4ArithmeticGrammar extends Grammar {
  createSemantics(): Vector4ArithmeticSemantics;
  extendSemantics(superSemantics: Vector4ArithmeticSemantics): Vector4ArithmeticSemantics;
}

declare const ns: {
  BasicArithmetic: BasicArithmeticGrammar;
  Vector4Arithmetic: Vector4ArithmeticGrammar;
};
export default ns;
