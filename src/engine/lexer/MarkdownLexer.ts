...
export const expressionRules: moo.Rules = {
  ...
  TIMES_BY: { match: /\b[Tt][Ii][Mm][Ee][Ss] [Bb][Yy]\b/, type: phraseType({ "times by": "STAR" }) },
  MULTIPLY_BY: { match: /\b[Mm][Uu][Ll][Tt][Ii][Pp][Ll][Yy] [Bb][Yy]\b/, type: phraseType({ "multiply by": "STAR" }) },
  DIVIDE_BY: { match: /\b[Dd][Ii][Vv][Ii][Dd][Ee] [Bb][Yy]\b/, type: phraseType({ "divide by": "SLASH" }) },
