 ...
 *
 * Tests the lightweight pub/sub event bus for plugin communication:
 * - Listener registration and event emission
 * - Multi-listener, multi-event isolation
 * - Listener removal, removeAllListeners, re-registration
